                ...
                <div class="md:flex md:items-center md:gap-12">
                    <nav aria-label="Global" class="hidden md:block">
                        <ul class="flex items-center gap-6 text-sm">
                            <li>
                                <x-nav-link href="{{ route('guru.index') }}" :active="request()->routeIs('guru.index')">Guru</x-nav-link>
                            </li>
                        </ul>
                        <ul class="flex items-center gap-6 text-sm">
                            <li>
                                <x-nav-link href="{{ route('dosen.index') }}" :active="request()->routeIs('dosen.index')">Dosen</x-nav-link>
                            </li>
                        </ul>
                        <ul class="flex items-center gap-6 text-sm">
                            <li>
                                <x-nav-link href="{{ route('siswa.index') }}" :active="request()->routeIs('siswa.index')">Siswa</x-nav-link>
                            </li>
                        </ul>
                    </nav>
